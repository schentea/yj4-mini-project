  ...
  return (
    <div>
      <header className="w-full h-[100vh] relative">
        ...
        <motion.div opacity="true" initial={{ opacity: 0, y: -150 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.5 }} className="absolute top-[50%] left-[10%] transform -translate-x-1/2 -translate-y-1/2 text-white z-10">
          <h2 className="mb-5">자연이 숨쉬는 곳</h2>
          <h1 className="drop-shadow-2xl shadow-black">빛나는 제주</h1>
        </motion.div>
        <img src={logo} alt="로고" className="absolute top-4 left-2 h-[70px] xl:h-[60px]" />
