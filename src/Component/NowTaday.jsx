...
export default function NowTaday() {
  ...
  return (
    <>
      <section className="w-full  h-[190vh] xl:h-[290vh]  xl:flex-row pb-16 bg-[url('./image/bg.jpg')] bg-cover bg-center bg-fixed flex flex-col xl:items-start items-center ">
        {/* 왼쪽 공간 */}
        <div className="w-1/3  h-screen flex flex-col justify-center items-center  mx-auto xl:ml-20  xl:sticky xl:top-0  ">
          {/* 주황색 제목 */}
            ...
            <div className=" relative w-[80%] h-[300px] ">
              {limitedData.map((item, index) => (
                <>
                  ...
                  >
                    <div className="h-[50%] p-4 bg-black bg-opacity-50 absolute bottom-0 left-0 right-0 overflow-hidden translate-y-full group-hover:translate-y-0 duration-500 ">
                      {item.introduction}
                    </div>
                  </div>
                  <div className="text-center">
                    <h2 className="text-3xl truncate overflow-hidden whitespace-nowrap text-white ">
                      {item.title}
                    </h2>
                  </div>
                </>
