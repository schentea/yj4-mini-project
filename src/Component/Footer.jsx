...
export default function Footer() {
  return (
    <>
      <footer className="w-full xl:h-[130px] bg-[#FFF2E5] xl:flex justify-between">
        {/* 푸터 왼쪽 */}
        <div className="xl:w-1/2 xl:ml-16 ml-8 h-full flex flex-col xl:justify-center text-[#666]">
          ...
          <div className="flex xl:space-x-6 space-x-16 font-semibold mr-8">
            <p>Instagram API</p>
        ...
        {/* 푸터 오른쪽 */}
        <div className="xl:w-1/2 w-[200px] flex justify-between xl:justify-end space-x-16 xl:space-x-0  items-center xl:mr-16 ml-8 mt-4 flex-wrap">
          <img
            ...
            alt="img"
          />
          <img className="xl:h-[60%]" src={FooterLogo} alt="img" />
        </div>
      </footer>
    </>
  );
