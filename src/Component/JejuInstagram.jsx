        ...
        <div className="w-full max-w-[1300px] h-full p-4 overflow-hidden">
          ...
          <div className="w-full flex items-center mt-16 flex-col">
            ...
            <div className="w-full h-full flex justify-center">
              <div id="Main_Grid" className="w-full h-full text-white grid xl:grid-cols-4 grid-rows-2 gap-4">
                <div className="flex justify-center items-center">
                  <img src={Harbang} alt="empty" className="w-full h-[680px] object-cover object-center" />
                </div>
                <div className="flex justify-center items-center">
                  <img src={Harbang} alt="empty" className="w-full h-[330px] object-cover object-center" />
                </div>
                <div className="flex justify-center items-center">
                  <img src={Harbang} alt="empty" className="w-full h-[330px] object-cover object-center " />
                </div>
