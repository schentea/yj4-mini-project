          ...
          <div className="flex justify-between mb-[80vw] lg:mb-[50vw] xl:mb-32 relative ">
            ...
            <div className="xl:w-[30%] mr-4">
              <div className="w-full bg-gray-700 flex flex-col items-center rounded-2xl">
                <a href="https://www.visitjeju.net/kr/bigdatamap/" target="_blank" rel="noreferrer">
                  <img
              ...
              <Carousel id="Carousel">
                ...
                <Carousel.Item>
                  <a href="https://www.instagram.com/apecjeju2025/" target="_blank" rel="noreferrer">
                    <img className="d-block w-100 max-h-[408px] object-cover object-bottom" src="https://visitjeju.net/image/main/right_ban_apec2.jpg" alt="Second slide" />
                  </a>
                  <Carousel.Caption></Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                  <a href="https://www.kareumstay.com/" target="_blank" rel="noreferrer">
                    <img className="d-block w-100 max-h-[408px] object-cover" src={stay} alt="Third slide" />
                  </a>
                  <Carousel.Caption></Carousel.Caption>
                </Carousel.Item>
              </Carousel>
            ...
            <div className="xl:w-[30%]">
              <div className="w-full bg-gray-700 flex flex-col items-center rounded-2xl overflow-hidden">
                <a className="w-full" href="https://www.safejeju.com/" target="_blank" rel="noreferrer">
                  <img
                    className="w-full"
